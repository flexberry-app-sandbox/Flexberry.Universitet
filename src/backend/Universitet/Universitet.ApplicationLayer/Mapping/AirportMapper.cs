namespace Universitet.ApplicationLayer.Mapping
{
    ...
    /// <summary>
    /// Статический маппер для преобразования между сущностью <see cref="Airport"/> и её DTO.
    /// </summary>
    public static class AirportMapper
    {
        /// <summary>
        /// Преобразует <see cref="Airport"/> в указанный DTO.
        /// </summary>
        /// <typeparam name="TDto">Тип DTO.</typeparam>
        /// <param name="source">Исходная сущность.</param>
        /// <returns>Указанный DTO.</returns>
        public static TDto MapToDto<TDto>(this Airport source)
        ...
        /// <summary>
        /// Обновляет поля сущности <see cref="Airport"/> по данным из DTO.
        /// </summary>
        /// <typeparam name="TDto">Тип DTO.</typeparam>
        /// <param name="destination">Сущность, которую нужно обновить.</param>
        /// <param name="source">DTO с новыми значениями.</param>
        public static void UpdateFromDto<TDto>(this Airport destination, TDto source)
            where TDto : AirportDtoBase
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
