namespace Universitet.ApplicationLayer.Mapping
{
    ...
    /// <summary>
    /// Статический маппер для преобразования между сущностью <see cref="Aircraft"/> и её DTO.
    /// </summary>
    public static class AircraftMapper
    {
        /// <summary>
        /// Преобразует <see cref="Aircraft"/> в указанный DTO.
        /// </summary>
        /// <typeparam name="TDto">Тип DTO.</typeparam>
        /// <param name="source">Исходная сущность.</param>
        /// <returns>Указанный DTO.</returns>
        public static TDto MapToDto<TDto>(this Aircraft source)
            where TDto : AircraftDtoBase, new()
        {
            if (source == null)
            {
        ...
        /// <summary>
        /// Обновляет поля сущности <see cref="Aircraft"/> по данным из DTO.
        /// </summary>
        /// <typeparam name="TDto">Тип DTO.</typeparam>
        /// <param name="destination">Сущность, которую нужно обновить.</param>
        /// <param name="source">DTO с новыми значениями.</param>
        public static void UpdateFromDto<TDto>(this Aircraft destination, TDto source)
            where TDto : AircraftDtoBase
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
