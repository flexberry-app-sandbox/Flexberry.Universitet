namespace Universitet.ApplicationLayer.Services
{
    using System;
    using System.Linq;
    using System.Net;
    ...
    /// </summary>
    public class UniversitetCurrentUserService : IUniversitetCurrentUserService
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UniversitetCurrentUserService"/> class.
        /// </summary>
        /// <param name="httpContextAccessor">Доступ к текущему контексту.</param>
        /// <param name="dataService">Сервис для вычитки данных.</param>
        public UniversitetCurrentUserService(IHttpContextAccessor httpContextAccessor, IDataService dataService)
        {
