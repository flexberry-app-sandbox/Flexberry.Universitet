namespace Universitet.WebAPI.Controllers
{
    ...
    using Universitet.ApplicationLayer.DTO.File;
    ...
    public partial class FileController : ControllerBase
    {
        ...
        private readonly IUniversitetCurrentUserService _currentUserService;
        ...
        public FileController(IConfiguration configuration, IUniversitetCurrentUserService currentUserService)
        {
